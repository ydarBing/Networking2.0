...
/************************************************************************/
  Message::Message()
    : data_(new Data(MessageError::OK, MessagePriority::LOW, 0, NULL)), flags_(0), mustSend_(false)
  {
    createTime_ = GetTickCount();
    //Not worth checking ret val; End would be imminent
  }

  Message::Message(MessageError::MESSEGE_ERROR meErr)
    : data_(new Data(meErr, MessagePriority::LOW, 0, NULL)), flags_(0), mustSend_(false)
  {
    createTime_ = GetTickCount();
    //Not worth checking ret val; End would be imminent
  }
  ...
  Message::Message(const c08* buffer, u16 size, bool mustSend)
    ...
    : data_(new Data(MessageError::OK, MessagePriority::LOW, 0, NULL)), flags_(0), mustSend_(false)
  {
    ...
    data_->buffer_ = new c08[data_->size_];
  ...
  Message::Message(const Message& rhs) : flags_(rhs.flags_), sequenceNum_(rhs.sequenceNum_),
    mustSend_(rhs.mustSend_), createTime_(rhs.createTime_)
  {
  ...
  Message& Message::operator=(const Message& rhs)
  {
    ...
    mustSend_ = rhs.mustSend_;
    createTime_ = rhs.createTime_;
    return *this;
  }
  ...
  bool Message::MustSend()
  {
    return mustSend_;
  }

  void Message::MustSend(bool send)
  {
    mustSend_ = send;
  }
